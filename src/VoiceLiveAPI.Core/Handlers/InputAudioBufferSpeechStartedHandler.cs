...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Handlers
{
    ...
    /// </summary>
    public class InputAudioBufferSpeechStartedHandler : VoiceLiveHandlerBase<SpeechStarted>
    {
        /// <summary>
        ///     Gets the event type for input audio buffer speech started.
        /// </summary>
        public const string EventType = SpeechStarted.TypeName;
        ...
        /// </summary>
        public override event Action<SpeechStarted> OnProcessMessage;
        ...
        {
            var json = message.Deserialize<SpeechStarted>() ??
                       throw new InvalidOperationException(
                           "Deserialization failed for SpeechStarted.");
