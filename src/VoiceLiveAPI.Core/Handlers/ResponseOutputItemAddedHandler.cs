...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Handlers
{
    ...
    /// </summary>
    public class ResponseOutputItemAddedHandler : VoiceLiveHandlerBase<OutputItemAdded>
    {
        /// <summary>
        ///     Gets the event type for response output Item added.
        /// </summary>
        public const string EventType = OutputItemAdded.TypeName;
        ...
        /// </summary>
        public override event Action<OutputItemAdded> OnProcessMessage;
        ...
        {
            var json = message.Deserialize<OutputItemAdded>() ??
                       throw new InvalidOperationException(
                           "Deserialization failed for OutputItemAdded.");
