...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Handlers
{
    ...
    /// </summary>
    public class ResponseAudioDoneHandler : VoiceLiveHandlerBase<AudioDone>
    {
        /// <summary>
        ///     Gets the event type for response audio done.
        /// </summary>
        public const string EventType = AudioDone.TypeName;
        ...
        /// </summary>
        public override event Action<AudioDone> OnProcessMessage;
        ...
        {
            var json = message.Deserialize<AudioDone>() ??
                       throw new InvalidOperationException("Deserialization failed for AudioDone.");
