...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Handlers
{
    ...
    /// </summary>
    public class ResponseContentPartDoneHandler : VoiceLiveHandlerBase<ContentPartDone>
    {
        /// <summary>
        ///     Gets the event type for response content part done.
        /// </summary>
        public const string EventType = ContentPartDone.TypeName;
        ...
        /// </summary>
        public override event Action<ContentPartDone> OnProcessMessage;
        ...
        {
            var json = message.Deserialize<ContentPartDone>() ??
                       throw new InvalidOperationException(
                           "Deserialization failed for ContentPartDone.");
