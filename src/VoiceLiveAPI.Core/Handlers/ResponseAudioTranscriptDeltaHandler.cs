...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Handlers
{
    ...
    /// </summary>
    public class ResponseAudioTranscriptDeltaHandler : VoiceLiveHandlerBase<TranscriptDelta>
    {
        /// <summary>
        ///     Gets the event type for response audio transcript delta.
        /// </summary>
        public const string EventType = TranscriptDelta.TypeName;
        ...
        /// </summary>
        public override event Action<TranscriptDelta> OnProcessMessage;
        ...
        {
            var json = message.Deserialize<TranscriptDelta>() ??
                       throw new InvalidOperationException(
                           "Deserialization failed for TranscriptDelta.");
