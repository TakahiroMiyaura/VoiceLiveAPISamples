...
{
    /// <summary>
    ///     Represents a streaming hosted Foundry agent call arguments delta event.
    /// </summary>
    /// <remarks>
    ///     Received as the model-generated arguments for a hosted Foundry agent tool call are updated.
    ///     One of the "hosted agent invocation events" added in API version 2026-06-01-preview.
    /// </remarks>
    public class FoundryAgentCallArgumentsDelta : ToolCallArgumentsDelta
    {
