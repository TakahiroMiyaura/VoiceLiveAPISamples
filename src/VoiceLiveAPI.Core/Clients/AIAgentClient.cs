...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Clients
{
    ...
    public class AIAgentClient : VoiceLiveAPIClientBase
    {
        ...
        public AIAgentClient(string endpoint, string accessToken, AuthenticationType authType, string projectName,
            string agentId,
        ...
        {
            Log(LogLevel.Information, $"Connecting to AI Agent - Project: {ProjectName}, Agent: {AgentId}");
        ...
        /// </summary>
        public string AgentAccessToken { get; }

        /// <summary>
        ///     Gets or sets the logger instance for this client.
        /// </summary>
        public override ILogger Logger { set; get; } = LoggerFactoryManager.CreateLogger<AIAgentClient>();
