...
namespace Com.Reseul.Azure.AI.Samples.VoiceLiveAPI.Commons.Messages
{
    ...
    public class ClientSession
    {
        ...
        /// </summary>  
        public string input_audio_format { get; set; } = null;

        /// <summary>  
        /// Gets or sets the output audio format. Supported formats: pcm16, g711_ulaw, g711_alaw.  
        /// </summary>  
        public string output_audio_format { get; set; } = null;

        /// <summary>  
        /// Gets or sets the settings for input audio noise reduction.  
        /// </summary>  
        public AudioInputAudioNoiseReductionSettings input_audio_noise_reduction { get; set; } = null;

        /// <summary>  
        /// Gets or sets the settings for input audio transcription.  
        /// </summary>  
        public AudioInputTranscriptionSettings input_audio_transcription { get; set; } = null;

        /// <summary>  
        /// Gets or sets the settings for input audio echo cancellation.  
        /// </summary>  
        public AudioInputEchoCancellationSettings input_audio_echo_cancellation { get; set; } = null;

        /// <summary>  
        /// Gets or sets the configuration for turn detection.  
        /// </summary>  
        public TurnDetection turn_detection { get; set; } = null;
        ...
        /// </summary>  
        public string tool_choice { get; set; } = null;

        /// <summary>  
        /// Gets or sets the maximum number of response output tokens. Can be an integer or "inf".  
        /// </summary>  
        public string max_response_output_tokens { get; set; } = null;
        ...
        /// </summary>  
        public string[] output_audio_timestamp_types { get; set; } = null;
