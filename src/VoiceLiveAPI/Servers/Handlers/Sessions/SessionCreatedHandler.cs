...
namespace Com.Reseul.Azure.AI.Samples.VoiceLiveAPI.Servers.Handlers.Sessions
{
    ...
    public class SessionCreatedHandler : VoiceLiveHandlerBase<SessionCreated>
    {
        ...
        /// </summary>
        public override event Action<SessionCreated> OnProcessMessage = null;
        ...
        /// <exception cref="InvalidOperationException">Thrown when deserialization fails for the session created message.</exception>
