...
namespace Com.Reseul.Azure.AI.Samples.VoiceLiveAPI.Servers.Handlers.InputAudioBuffers
{
    ...
    public class InputAudioBufferCommittedHandler : VoiceLiveHandlerBase<InputAudioBufferCommitted>
    {
        ...
        /// </summary>
        public static string EventType = InputAudioBufferCommitted.Type;
        ...
        /// </summary>
        public override event Action<InputAudioBufferCommitted> OnProcessMessage = null;
        ...
        public override async Task HandleAsync(JsonElement message)
        {
            ...
            if (json == null)
                throw new InvalidOperationException("Deserialization failed for InputAudioBufferCommittedMessage.");
