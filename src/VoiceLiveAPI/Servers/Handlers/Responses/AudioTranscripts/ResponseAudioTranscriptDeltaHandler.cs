...
namespace Com.Reseul.Azure.AI.Samples.VoiceLiveAPI.Servers.Handlers.Responses.AudioTranscripts
{
    ...
    public class ResponseAudioTranscriptDeltaHandler : VoiceLiveHandlerBase<ResponseAudioTranscriptDelta>
    {
        ...
        /// </summary>
        public override event Action<ResponseAudioTranscriptDelta> OnProcessMessage = null;
        ...
        /// <exception cref="InvalidOperationException">Thrown when deserialization fails for the response audio transcript delta message.</exception>
