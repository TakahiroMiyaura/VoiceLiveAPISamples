...
namespace Com.Reseul.Azure.AI.Samples.VoiceLiveAPI.Servers.Handers.Unconfirmed.Responses.FunctionCallArguments
{
    ...
    /// </summary>
    public class
        ResponseFunctionCallArgumentsDoneHandler : VoiceLiveHandlerBase<ResponseFunctionCallArgumentsDoneMessage>
    {
        /// <summary>
        ...
        /// </summary>
        public override event Action<ResponseFunctionCallArgumentsDoneMessage> OnProcessMessage = null;
        ...
        public override async Task HandleAsync(JsonElement message)
        {
            ...
            if (responseFunctionCallArgumentsDone == null)
                throw new InvalidOperationException(
                    "Deserialization failed for ResponseFunctionCallArgumentsDoneMessage.");
