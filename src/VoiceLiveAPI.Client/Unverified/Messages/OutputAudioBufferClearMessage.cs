...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Client.Unverified.Messages
{
    ...
    /// </summary>
    [Obsolete(
        "This class is obsolete. Use Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Commands.Messages.Unverified.OutputAudioBufferClearMessage instead.")]
    public class OutputAudioBufferClearMessage : ClientCommand
    {
