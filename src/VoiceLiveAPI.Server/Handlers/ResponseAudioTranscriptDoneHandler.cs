...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Server.Handlers
{
    ...
    /// </summary>
    [Obsolete(
        "This class is obsolete. Use Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Handlers.ResponseAudioTranscriptDoneHandler instead.")]
    public class ResponseAudioTranscriptDoneHandler : VoiceLiveHandlerBase<ResponseAudioTranscriptDone>
    {
        ...
        /// </summary>
        public const string EventType = ResponseAudioTranscriptDone.TypeName;
        ...
        public override async Task HandleAsync(JsonElement message)
        {
            var json = message.Deserialize<ResponseAudioTranscriptDone>() ??
                       throw new InvalidOperationException(
                           "Deserialization failed for ResponseAudioTranscriptDoneMessage.");
