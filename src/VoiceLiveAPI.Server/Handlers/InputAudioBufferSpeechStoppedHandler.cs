...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Server.Handlers
{
    ...
    /// </summary>
    [Obsolete(
        "This class is obsolete. Use Com.Reseul.Azure.AI.VoiceLiveAPI.Core.Handlers.InputAudioBufferSpeechStoppedHandler instead.")]
    public class InputAudioBufferSpeechStoppedHandler : VoiceLiveHandlerBase<InputAudioBufferSpeechStopped>
    {
        ...
        /// </summary>
        public const string EventType = InputAudioBufferSpeechStopped.TypeName;
        ...
        /// </summary>
        public override event Action<InputAudioBufferSpeechStopped> OnProcessMessage;
        ...
        public override async Task HandleAsync(JsonElement message)
        {
            var json = message.Deserialize<InputAudioBufferSpeechStopped>() ??
                       throw new InvalidOperationException(
                           "Deserialization failed for InputAudioBufferSpeechStoppedMessage.");
