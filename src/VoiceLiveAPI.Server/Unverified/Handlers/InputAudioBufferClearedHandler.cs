...
namespace Com.Reseul.Azure.AI.VoiceLiveAPI.Server.Unverified.Handlers
{
    ...
    public class InputAudioBufferClearedHandler : VoiceLiveHandlerBase<InputAudioBufferClearedMessage>
    {
        ...
        /// </summary>
        public const string EventType = "input_audio_buffer.cleared";
        ...
        public override ILogger Logger { set; get; } =
            LoggerFactoryManager.CreateLogger<InputAudioBufferClearedHandler>();

        /// <summary>
        ///     Occurs when an input audio buffer cleared message is processed.
        /// </summary>
        public override event Action<InputAudioBufferClearedMessage> OnProcessMessage;
